...
with open(test_out, 'w', encoding='utf8') as tout, open(test_feat_out, 'w', encoding='utf8') as tfout:
    for index_out in range(max_test_number):
        if index_out < max_test_number - 1:
            x_test, y_test, y_test_issue, y_test_multi, test_whole = x_temp_test[index_out * MAX_TEST_DATA: (index_out + 1) * MAX_TEST_DATA], \
            ...
            x_test, y_test, y_test_issue, y_test_multi, test_whole = x_temp_test[index_out * MAX_TEST_DATA:], \
        ...
        # model2.save_weights('weights_issue_classification_only.h5',overwrite=True)
        #
