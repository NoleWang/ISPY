...
# General arguments
parser.add_argument('--prefix', default="C:/Users/wangs/Documents/GitFiles/ISPY/disentanglement/src/example-train", help="Start of names for files produced.")
...
parser.add_argument('--test', nargs="+", help="Test files, e.g. test/*annotation.txt", default="C:\\Users\\wangs\\Desktop\\Test\\Scikitlearn\\*ascii*")# , default='../data/test_disentangled/*ascii*'
...
parser.add_argument('--model', help="A file containing a trained model", default='C:\\Users\\wangs\\Documents\\GitFiles\\ISPY\\disentanglement\\src\\example-train.dy.model')#
...
train = []
if args.train:
    filenames = glob.glob(r''+str(args.train))
    train = read_data(filenames)
dev = []
if args.dev:
    filenames = glob.glob(r''+str(args.dev))
    dev = read_data(filenames)
test = dev
if args.test:
    filenames = glob.glob(r''+str(args.test))
    # filenames = args.test
