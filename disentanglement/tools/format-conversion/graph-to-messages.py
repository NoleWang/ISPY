...
def union_find(nodes, edges):
    ...
    for n in parents:
        ...
        clusters.setdefault(find(n, parents), list()).append(n)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ascii', help="File containing the ascii version of the data",default="../../data/DisentangledData/angular_angular_chatFormat.ascii.txt")
    parser.add_argument('--annotations', help="File containing the graph annotations",default="../../data/DisentangledData/angular_angular_chatFormat.annotation.txt")
